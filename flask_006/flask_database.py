...
class FlaskDataBase:
    ...
    def add_user(self, name, email, hpsw):
        try:
            ...
            if result['count'] > 0:
                print("Ошибка email или пароль уже существует")
                return "state0"
            ...
            print("Ошибка добавления смешарика"+str(e))
            return "state1"
        return "state2"
    ...
    def get_user(self, user_id):
        try:
            ...
            res = self.__cur.fetchone()
            if not res:
                print("Не нашли смешарика")
                return False
            return res
        except sqlite3.Error as e:
            print("Ошибка с бд"+str(e))
